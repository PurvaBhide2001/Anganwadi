...
import { AnganwadiSmartStatusScreen } from "../screens/AnganwadiProfileScreen/AnganwadiSmartStatusPage"
/**
...
export const AnganwadiProfileScreenStack = observer(function AppStack() {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="FunctionsAndServicesByAWC" component={FunctionsAndServicesByAWCScreen} />
      <Stack.Screen name="InfrastructureFacilities" component={InfrastructureFacilitiesScreen} />
      ...
      <Stack.Screen name="AnganwadiSmartStatus" component={AnganwadiSmartStatusScreen} />
    </Stack.Navigator>
  )
})
