...
export const QuestionScreen: FC<QuestionScreenProps> = observer(function QuestionScreen({
  ...
  const { nextQuestion, previousQuestion, changesButton } = useQuestionContext()
  const { onSubmitQuestionAnswer } = useStudentContextContext()
  const { onSubmitFeedBack } = useFeedbackContextContext()
  // useHeader({
  //   title: " प्रश्न संच",
  //   titleStyle: { fontStyle: "normal", fontSize: responsiveFontSize(2.5), fontWeight: "700", color="#7d8592" },
      ...
      >
        ...
        <Box flex={1} height="100%" width="100%">
          <Box flex={1} flexDirection="column">
            <Box justifyContent="center" flex={1} width="100%" height={responsiveHeight(15)}>
              <Image alt="image1" source={image3} />
            </Box>
            <Box
              flex={1}
              width="100%"
            ...
            <Center flex={1} flexDirection="row">
              <Center flex={6} width="100%">
                <Image source={image1} alt="image1" />
              </Center>
              <Center flex={6} width="100%">
                <Image source={image2} alt="image1" />
              </Center>
            </Center>
              ...
              <Box flex={1} flexDirection="row">
                ...
                <Box flex={6} alignItems="center" padding={responsiveWidth(5)}>
                  {!changesButton ? (
                    ...
                    <Box flex={6} alignItems="center" flexDirection="column">
                      <Box flex={4}></Box>
                      <TouchableOpacity
                        style={{
                          flex: 4,
