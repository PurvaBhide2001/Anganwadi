...
// import { useAakarDetailsContext } from "../../Context/AakarDetailsContext"
...
import ShowAllSuvidhaList from "../AnganwadiSuvidha/ShowAndAddSuvidha/ShowAllSuvidhaList"
import AakarDetailList from "./AakarDetailList"

interface AakarDetailsProps extends AppStackScreenProps<"AakarDetails"> {}

export const AakarDetailsScreen: FC<AakarDetailsProps> = observer(function AakarDetails({
  navigation,
}) {
