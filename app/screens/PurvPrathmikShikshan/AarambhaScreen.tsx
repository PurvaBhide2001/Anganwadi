...
// import { useAarambhaContext } from "../../Context/AarambhaContext"
...
interface AarambhaProps extends AppStackScreenProps<"Aarambha"> {}

export const AarambhaScreen: FC<AarambhaProps> = observer(function Aarambha({ navigation }) {
  ...
  //   const { menuSMList, menuMDList } = useAarambhaContext()
  return (
    <>
      <LinearGradient
