...
// import { useEDDContext } from "../../Context/EDDContext"
...
interface EDDProps extends AppStackScreenProps<"EDD"> {}

export const EDDScreen: FC<EDDProps> = observer(function EDD({ navigation }) {
  ...
  //   const { menuSMList, menuMDList } = useEDDContext()
  return (
    <>
      <LinearGradient
