...
// import { useSamMamContext } from "../../Context/SamMamContext"
...
interface SamMamProps extends AppStackScreenProps<"SamMam"> {}

export const SamMamScreen: FC<SamMamProps> = observer(function SamMam({ navigation }) {
