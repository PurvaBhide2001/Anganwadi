...
// import { useWeeklyReportContext } from "../../Context/WeeklyReportContext"
...
interface WeeklyReportProps extends AppStackScreenProps<"WeeklyReport"> {}

export const WeeklyReportScreen: FC<WeeklyReportProps> = observer(function WeeklyReport({
  navigation,
}) {
  ...
  //   const { menuSMList, menuMDList } = useWeeklyReportContext()
  return (
    <>
      <LinearGradient
