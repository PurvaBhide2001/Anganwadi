...
// import { useVDCCContext } from "../../Context/VDCCContext"
...
interface VDCCProps extends AppStackScreenProps<"VDCC"> {}

export const VDCCScreen: FC<VDCCProps> = observer(function VDCC({ navigation }) {
  ...
  //   const { menuSMList, menuMDList } = useVDCCContext()
  return (
    <>
      <LinearGradient
