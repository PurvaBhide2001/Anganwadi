...
interface ChooseNipunBharatStudentForShowResultScreenProps
  extends AppStackScreenProps<"ChooseNipunBharatStudentForShowResult"> {}

export const ChooseNipunBharatStudentForShowResultScreen: FC<ChooseNipunBharatStudentForShowResultScreenProps> =
  observer(function ChooseNipunBharatStudentForShowResultScreen({ navigation }) {
    const { setToTheStudent, studentID, onChangeStudent, onSubmitToShowExamCategoeries } =
        ...
        >
          <Box flex={1} flexDirection="column">
            ...
            <Box flex={5} alignItems="center" padding={responsiveWidth(2)}>
              <Image
                source={require("../../../assets/nipunBharatIcons/nipun-bharat.png")}
                alt="Alternate Text"
                resizeMode="cover"
              />
            </Box>
            ...
            <Box flex={1} alignItems="center" padding={responsiveWidth(2)}>
              <TouchableOpacity
                ...
                onPress={() => onSubmitToShowExamCategoeries()}
              >
                <Text
                  textAlign="center"
                  color={"warmGray.500"}
