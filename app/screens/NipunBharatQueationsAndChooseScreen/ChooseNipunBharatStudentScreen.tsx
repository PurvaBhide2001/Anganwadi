...
interface ChooseNipunBharatStudentScreenProps
  extends AppStackScreenProps<"ChooseNipunBharatStudent"> {}

export const ChooseNipunBharatStudentScreen: FC<ChooseNipunBharatStudentScreenProps> = observer(
  function ChooseNipunBharatStudentScreen({ navigation }) {
    const { setToTheStudent, studentID, onChangeStudent } = useNipunBharatStudentContextContext()
