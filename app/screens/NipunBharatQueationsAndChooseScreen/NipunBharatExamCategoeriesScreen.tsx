...
interface NipunBharatExamCategoeriesScreenProps
  extends AppStackScreenProps<"NipunBharatExamCategoeries"> {}

export const NipunBharatExamCategoeriesScreen: FC<NipunBharatExamCategoeriesScreenProps> = observer(
  function NipunBharatExamCategoeriesScreen({ navigation }) {
    ...
    const { examCategoeries, examCategoery, onClickQuestionCategoery } =
